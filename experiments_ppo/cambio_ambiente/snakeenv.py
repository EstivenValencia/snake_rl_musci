...
class SnakeEnv(gym.Env):
    def __init__(self, render=None, record=False):
    ...
    def step(self, action):
        ...
        print("Distancia a la comida: {}".format(euclidean_dist_to_apple))
        if self.prev_distance >= euclidean_dist_to_apple:
        ...
        self.prev_distance = euclidean_dist_to_apple
    ...
    def reset(self, seed=None, options=None):
        ...
        self.prev_distance = np.linalg.norm(np.array([500,500]))
        self.prev_reward = 0
